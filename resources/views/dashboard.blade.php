<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-3  gap-4 auto-cols-max gap-4">
                <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                    ...
                    <div class="bg-gray-100 mx-6 my-2 p-3 rounded grid grid-cols-2">
                        <div class="align-items-center flex flex-col content-center items-center">
